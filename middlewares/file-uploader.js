...
// Uploader reutilizable para restaurantes, menús y perfiles
export const uploadBranchImage = createMemoryUploader();
export const uploadMenuImage = createMemoryUploader();
